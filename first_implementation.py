...
mlp = MLPClassifier(hidden_layer_sizes=(5,),  # number of neurons in the hidden layer
                    ...
                    learning_rate_init=.3, # learning rate for the optimization algorithm. It determines the size of the steps
